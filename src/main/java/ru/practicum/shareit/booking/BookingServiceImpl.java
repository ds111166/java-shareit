...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    @Transactional
    public List<BookingDto> getBookings(Long bookerId, State state) {
    ...
    @Override
    @Transactional
    public List<BookingDto> getBookingsByOwnerItemId(Long ownerItemId, State state) {
        userService.getUserById(ownerItemId);
        List<Booking> bookings;
        final Sort sorting = Sort.by(Sort.Order.desc("start"));
        final LocalDateTime nowDateTime = LocalDateTime.now();
    ...
    public BookingDto findFirstByItem_IdAndEndAfterOrderByStartDesc(Long itemId, LocalDateTime nowDateTime) {
        Booking bookingLast = bookingRepository.findFirstByItem_IdAndEndAfterOrderByStartDesc(itemId, nowDateTime);
