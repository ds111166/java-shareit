...
public class ItemServiceImpl implements ItemService {
    ...
    public List<ItemDto> getOwnerItems(Long ownerId) {
        ...
        for (Item item : items) {
            ...
            final Booking bookingNext = bookingRepository
                    .findFirstByItemIdAndStatusIdAndStartAfterOrderByStartAsc(itemId,
                            StatusBooking.WAITING, nowDateTime);
    ...
    public ItemDto getItemById(Long userId, Long itemId) {
        ...
        final Booking bookingNext = (isOwner)
                ? bookingRepository
                .findFirstByItemIdAndStatusIdAndStartAfterOrderByStartAsc(itemId, StatusBooking.WAITING, nowDateTime)
                : null;
        final BookingDto bookingDtoNext = bookingMapper.toBookingDto(bookingNext);
